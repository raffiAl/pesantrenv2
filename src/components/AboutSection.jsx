    ...
    <section id="profil" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          {/* Visi Card */}
          <div className="bg-gradient-to-br from-pesantren-green to-pesantren-emerald rounded-2xl p-8 text-white shadow-xl">
            <div className="flex items-center mb-6">
              <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center mr-4">
                <Target className="w-7 h-7 text-pesantren-gold" />
              </div>
          ...
          {/* Misi Card */}
          <div className="bg-pesantren-cream rounded-2xl p-8 shadow-lg border border-pesantren-green/10">
            <div className="flex items-center mb-6">
              <div className="w-14 h-14 bg-pesantren-green/10 rounded-full flex items-center justify-center mr-4">
                <BookOpen className="w-7 h-7 text-pesantren-green" />
              </div>
              <h3 className="text-2xl font-bold text-pesantren-green">Misi Kami</h3>
            </div>
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start">
                  <span className="w-6 h-6 bg-pesantren-gold rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                    <span className="text-pesantren-green text-xs font-bold">{index + 1}</span>
                  </span>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold text-pesantren-green mb-4">
              Sejarah Singkat
            </h3>
            <div className="w-24 h-1 bg-pesantren-gold mx-auto"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-16">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-pesantren-gold rounded-full flex items-center justify-center shadow-lg">
                <span className="text-pesantren-green font-bold text-center text-sm">
                  1985<br />Didirikan
                </span>
              </div>
            </div>
            <div className="lg:pl-8">
              <h4 className="text-xl font-bold text-pesantren-green mb-4">Tahun Berdiri</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-16">
            <div className="lg:order-2 relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-pesantren-emerald rounded-full flex items-center justify-center shadow-lg">
                <span className="text-white font-bold text-center text-sm">
                  2005<br />Ekspansi
                </span>
              </div>
            </div>
            <div className="lg:order-1 lg:pr-8 text-right lg:text-left">
              <h4 className="text-xl font-bold text-pesantren-green mb-4">Era Pengembangan</h4>
              <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-pesantren-green rounded-full flex items-center justify-center shadow-lg">
                <Award className="w-8 h-8 text-pesantren-gold" />
              </div>
            </div>
            <div className="lg:pl-8">
              <h4 className="text-xl font-bold text-pesantren-green mb-4">Prestasi & Pengakuan</h4>
              <p className="text-gray-600 leading-relaxed mb-4">
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-pesantren-green to-pesantren-emerald rounded-2xl p-8 sm:p-12">
            ...
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
                  <stat.icon className="w-6 h-6 text-pesantren-gold" />
                </div>
